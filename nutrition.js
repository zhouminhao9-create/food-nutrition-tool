...
const supplementSuggestions = {
    '蛋白质': '建议补充：鸡胸肉、鸡蛋、牛奶、豆腐等',
    '脂肪': '建议补充：牛油果、坚果、橄榄油等健康脂肪',
    '碳水化合物': '建议补充：米饭、面条、红薯、玉米等主食',
    '膳食纤维': '建议补充：新鲜蔬菜和水果，如西兰花、苹果、香蕉等',
    '维生素A': '建议补充：胡萝卜、南瓜、菠菜等橙黄色和深绿色蔬菜',
    '维生素C': '建议补充：新鲜果蔬，如橙子、猕猴桃、草莓、番茄等',
    '维生素B族': '建议补充：瘦肉、鸡蛋、全麦面包、糙米等',
    '维生素D': '建议补充：多晒太阳，或食用鸡蛋黄、牛奶',
    '钙': '建议补充：牛奶、酸奶、西兰花等',
    '铁': '建议补充：瘦肉、猪肝、菠菜、黑木耳等',
    '锌': '建议补充：瘦肉、坚果、豆类等',
    '钾': '建议补充：香蕉、橙子、土豆、菠菜等'
};
